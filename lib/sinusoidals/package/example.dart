  ...
  Widget build(BuildContext context) {
    return const MaterialApp(
      ...
      home: Scaffold(
        ...
        // body: _CombinedWaveDemo(),
        // body: _SinusoidalDemo(),
        body: _SinusoidalDemoJC(),
        // body: _MagmaWaveDemo(),
      ),
    );
  }
...
class _SinusoidalDemoJC extends StatelessWidget {
  const _SinusoidalDemoJC({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Column(
      mainAxisAlignment: MainAxisAlignment.center,
      children: [
        Container(height: 32, color: Colors.red),
        // const SizedBox(height: 32),
        Sinusoidal(
          reverse: true,
          // model: const SinusoidalModel(
