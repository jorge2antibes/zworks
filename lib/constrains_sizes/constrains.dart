...
/// https://widgettricks.substack.com/p/rule-1-constraints-go-down
...
class Example1_1 extends Example {
  const Example1_1({super.key});

  @override
  final code = 'Container(color: red_1_1)';

  @override
  final explanation = '1_1 '
      'and it forces the Container to be exactly the same size as the screen.'
      '\n\n'
      'So the Container fills the screen and paints it red.';
  ...
  Widget build(BuildContext context) {
    return Container(
      color: red,
      // constraints: BoxConstraints.tight(Size(200, double.infinity)),
      child: ConstrainedBox(
        constraints: BoxConstraints.loose(
          Size(
            200,
