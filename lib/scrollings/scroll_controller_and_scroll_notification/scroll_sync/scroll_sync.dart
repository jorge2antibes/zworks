...
class _ScrollSyncState extends State<ScrollSync> {
  ...
  @override
  void initState() {
    _controller1.addListener(() => _controller2.jumpToWithoutGoingIdleAndKeepingBallistic(_controller1.offset));
    _controller2.addListener(() => _controller1.jumpToWithoutGoingIdleAndKeepingBallistic(_controller2.offset));
    super.initState();
  }
...
class CustomScrollController extends ScrollController {
  ...
  void jumpToWithoutGoingIdleAndKeepingBallistic(double value) {
    ...
    for (_SilentScrollPosition position in new List<ScrollPosition>.from(positions) as Iterable<_SilentScrollPosition>)
