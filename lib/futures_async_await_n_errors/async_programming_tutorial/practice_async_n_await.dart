...
Future<String> reportUserRole() async {
  var thisRole = await fetchRole();
  return 'User role: $thisRole';
}

// Part 2
Future<String> reportLogins() async {
  var thisLogins = await fetchLoginAmount();
  return 'Total number of logins: $thisLogins';
}
    ...
    messages
      ..add(_makeReadable(
          ...
          readableErrors: {
            ...
            'null': 'Test failed! Did you forget to implement or return from reportUserRole?',
      ...
      ..add(_makeReadable(
          ...
          readableErrors: {
            typoMessage: typoMessage,
            'null': 'Test failed! Did you forget to implement or return from reportLogins?',
